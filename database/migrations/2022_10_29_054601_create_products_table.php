...
class CreateProductsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('products', function (Blueprint $table) {
            ...
            $table->string('image1', 2048)->default('/storage/products/default.jpg')->nullable();
            $table->string('image2', 2048)->default('/storage/products/default.jpg')->nullable();
            $table->string('image3', 2048)->default('/storage/products/default.jpg')->nullable();
            $table->string('image4', 2048)->default('/storage/products/default.jpg')->nullable();
